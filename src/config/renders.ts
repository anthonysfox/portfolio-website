...
function render(
  ...
  return {
    src: previewUrl(name),
    full: mediaUrl(nameOverride || name),
    filename,
    resolution,
    portrait,
  };
...
export const RENDERS: Render[] = [
  ...
  render(
    "simple_tree_in_room",
    "simple_tree_in_room.blend",
    "3840×2160 · CYCLES",
  ),
  render("forest_tree_house", "forest_tree_house.blend", "3840×2160 · CYCLES"),
  render(
    "ancient_meeting_place",
    "ancient_meeting_place.blend",
    "1920×1080 · CYCLES",
  ),
  render("preserving_beauty", "preserving_beauty.blend", "1280×720 · CYCLES"),
  render(
    "no_mans_sky_monolith",
    "no_mans_sky_monolith.blend",
    "1080×1920 · CYCLES",
    true,
  ),
  render(
    "stain_glass_hallway",
    "stain_glass_hallway.blend",
    "1080×1920 · CYCLES",
    true,
  ),
];
